<x-admin-layout>
    ...
    <div class="space-y-6">
        <form method="POST" action="{{ route('department-risk.store') }}"
              class="space-y-6"
            ...
            <div class="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm space-y-6">
                ...
                <div>
                    ...
                    <textarea id="risk_event_deta" name="risk_event_deta" rows="3" class="mt-2 w-full rounded-2xl border-slate-200 bg-white px-4 py-3 text-sm shadow-sm focus:border-indigo-500 focus:ring-indigo-500 @error('risk_event_deta') border-rose-500 @enderror" placeholder="Jelaskan detail risiko...">{{ old('risk_event_deta') }}</textarea>
            ...
            <div class="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
                ...
                {{-- Komponen Pilihan Unit Bergaya Grid List (Meniru SMAP) --}}
            ...
            <div class="flex items-center justify-end gap-3">
                ...
                <button type="submit" class="rounded-2xl bg-indigo-600 px-5 py-2.5 text-sm font-semibold text-white shadow-lg shadow-indigo-500/20 hover:bg-indigo-700 transition">Tambahkan Risk</button>
            </div>
        </form>
    </div>
</x-admin-layout>
