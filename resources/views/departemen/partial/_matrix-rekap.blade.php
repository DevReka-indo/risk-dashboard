    ...
    document.addEventListener("DOMContentLoaded", function() {
        ...
        new Chart(ctxStacked, {
            ...
            options: {
                ...
                plugins: {
                    legend: { position: 'top', align: 'end', labels: { usePointStyle: true, boxWidth: 10, font: { size: 12 } } }
                },
                scales: {
                    x: { stacked: true, beginAtZero: true, ticks: { stepSize: 1 }, grid: { color: '#f1f5f9' } },
                    y: { stacked: true, grid: { display: false }, ticks: { autoSkip: false, font: { size: 12, weight: '500' }, padding: 12 } }
                }
            }
        });
    });
