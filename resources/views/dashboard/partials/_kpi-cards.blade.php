<div class="grid grid-cols-1 gap-6 md:grid-cols-3 animate-fade-in-up">
    {{-- Card 1: Top Risk --}}
    <div id="card-top_risk" onclick="switchTab('top_risk')" class="kpi-card group relative cursor-pointer overflow-hidden rounded-lg border-2 border-rose-200 dark:border-rose-900/60 bg-gradient-to-br from-rose-50/80 via-white to-white dark:from-slate-900 dark:via-slate-900 dark:to-slate-900 p-6 shadow-sm transition-all duration-300 hover:-translate-y-1 hover:border-rose-300 dark:hover:border-rose-700 hover:shadow-xl">
        <div class="flex items-start justify-between">
            <div class="space-y-1">
                <div class="flex items-center gap-2">
                    <span class="inline-flex items-center gap-1.5 rounded-full bg-rose-100 dark:bg-rose-900/40 px-2.5 py-0.5 text-xs font-semibold text-rose-700 dark:text-rose-300">
                        <span class="h-1.5 w-1.5 rounded-full bg-rose-500 animate-pulse"></span>
                        Prioritas
                    </span>
                </div>
                <p class="text-sm font-semibold text-slate-600 dark:text-slate-300">Top Risk</p>
                <h2 class="text-3xl font-extrabold text-slate-900 dark:text-white tracking-tight">
                    {{ number_format($stats['high_risks'] ?? 0) }}
                </h2>
                <p class="text-xs text-slate-400 dark:text-slate-500">Risiko dengan prioritas tertinggi</p>
            </div>
        ...
        <div class="mt-4 flex items-center gap-1.5 text-xs font-semibold text-rose-600 dark:text-rose-400 border-t border-rose-100/60 dark:border-rose-900/40 pt-3">
    ...
    {{-- Card 2: SMAP --}}
    <div id="card-smap" onclick="switchTab('smap')" class="kpi-card group relative cursor-pointer overflow-hidden rounded-lg border-2 border-purple-200 dark:border-purple-800/60 bg-gradient-to-br from-purple-50/80 via-white to-white dark:from-slate-900 dark:via-slate-900 dark:to-slate-900 p-6 shadow-sm transition-all duration-300 hover:-translate-y-1 hover:border-purple-300 dark:hover:border-purple-600 hover:shadow-xl">        <div class="flex items-start justify-between">
            <div class="space-y-1">
                <div class="flex items-center gap-2">
                    <span class="inline-flex items-center gap-1.5 rounded-full bg-purple-100 dark:bg-purple-900/40 px-2.5 py-0.5 text-xs font-semibold text-purple-700 dark:text-purple-300">
                        <span class="h-1.5 w-1.5 rounded-full bg-purple-500"></span>
                        Kepatuhan
                    </span>
                </div>
                <p class="text-sm font-semibold text-slate-600 dark:text-slate-300">SMAP</p>
                <h2 class="text-3xl font-extrabold text-slate-900 dark:text-white tracking-tight">
                    {{ number_format($stats['total_smap'] ?? 0) }}
                </h2>
                <p class="text-xs text-slate-400 dark:text-slate-500">Sistem Manajemen Anti Penyuapan</p>
            </div>
        ...
        <div class="mt-4 flex items-center gap-1.5 text-xs font-semibold text-purple-600 dark:text-purple-400 border-t border-purple-100/60 dark:border-purple-800/40 pt-3">
    ...
    {{-- Card 3: Departemen --}}
    <div id="card-dep" onclick="switchTab('dep')" class="kpi-card group relative cursor-pointer overflow-hidden rounded-lg border-2 border-blue-200 dark:border-blue-800/60 bg-gradient-to-br from-blue-50/80 via-white to-white dark:from-slate-900 dark:via-slate-900 dark:to-slate-900 p-6 shadow-sm transition-all duration-300 hover:-translate-y-1 hover:border-blue-300 dark:hover:border-blue-600 hover:shadow-xl">
        <div class="flex items-start justify-between">
            <div class="space-y-1">
                <div class="flex items-center gap-2">
                    <span class="inline-flex items-center gap-1.5 rounded-full bg-blue-100 dark:bg-blue-900/40 px-2.5 py-0.5 text-xs font-semibold text-blue-700 dark:text-blue-300">
                        <span class="h-1.5 w-1.5 rounded-full bg-blue-500"></span>
                        Operasional
                    </span>
                </div>
                <p class="text-sm font-semibold text-slate-600 dark:text-slate-300">Departemen</p>
                <h2 class="text-3xl font-extrabold text-slate-900 dark:text-white tracking-tight">
                    {{ number_format($stats['total_dep'] ?? 0) }}
                </h2>
                <p class="text-xs text-slate-400 dark:text-slate-500">Monitoring risiko per departemen</p>
            </div>
        ...
        <div class="mt-4 flex items-center gap-1.5 text-xs font-semibold text-blue-600 dark:text-blue-400 border-t border-blue-100/60 dark:border-blue-800/40 pt-3">
