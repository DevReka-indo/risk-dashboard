<x-admin-layout>
    ...
    <form method="POST" action="{{ route('top-risk.update', $topRisk) }}">
        @csrf
        @method('PUT')
        ...
        <div class="rounded-2xl border border-slate-200 bg-white shadow-sm overflow-hidden">
            ...
            {{-- BARIS ATAS: Kolom kiri + Kolom kanan --}}
                    ...
                    <td style="padding:24px; vertical-align:top;">
                        <div style="display:flex; flex-direction:column; height:100%;">
                            ...
                            <textarea name="nama_peristiwa_risiko" required
                                      ...
                                      style="flex:1; width:100%; border:1px solid #e2e8f0; border-radius:10px; padding:12px; font-size:13px; color:#475569; background:#fff; resize:none; outline:none; min-height:200px; font-family:inherit; line-height:1.6;">{{ old('nama_peristiwa_risiko', $topRisk->nama_peristiwa_risiko) }}</textarea>
