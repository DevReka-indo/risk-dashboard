<x-admin-layout>
    ...
    <form method="POST" action="{{ route('top-risk.store') }}" x-data="topRiskForm">
        @csrf
                ...
                <tr>
                    ...
                    <td style="padding:24px; vertical-align:top;">
                        <div style="display:flex; flex-direction:column; height:100%;">
                            ...
                            {{-- Textarea Keterangan / Nama Peristiwa Risiko --}}
                            ...
                            <textarea name="nama_peristiwa_risiko" required
                                      ...
                                      style="flex:1; width:100%; border:1px solid #e2e8f0; border-radius:10px; padding:12px; font-size:13px; color:#475569; background:#fff; resize:none; outline:none; min-height:120px; font-family:inherit; line-height:1.6;">{{ old('nama_peristiwa_risiko') }}</textarea>
    ...
    @else
        <div style="display:grid; grid-template-columns:repeat(3,1fr); gap:10px;">
            @foreach ($unitKerja as $unit)
                <label class="unit-checkbox-card" style="display:flex; align-items:center; gap:10px; border:1px solid rgba(255,255,255,0.15); border-radius:10px; padding:10px 14px; cursor:pointer; transition:all 0.2s;">
...
<style>
    ...
    <script>
        document.addEventListener('alpine:init', () => {
            Alpine.data('topRiskForm', () => ({
                inherent: '{{ old('inherent', '') }}',
                levelName: '',
                levelId: '',
                levelStyle: '',
