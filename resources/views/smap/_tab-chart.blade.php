        ...
        <div class="flex flex-col items-center justify-center text-center">
            ...
            <div class="mt-3 max-w-md">
                <p class="text-sm text-slate-500">
                    Dashboard untuk Risk SMAP saat ini sedang dikembangkan. 
                    Fitur ini akan segera hadir untuk memudahkan Anda memonitoring risiko SMAP secara visual.
                </p>
            </div>
